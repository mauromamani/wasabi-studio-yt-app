        ...
        <div id="single-line" class="style-scope yt-live-chat-paid-message-renderer">
          ...
          <div id="purchase-amount-column" class="style-scope yt-live-chat-paid-message-renderer"> <yt-img-shadow
            ...
            <div id="purchase-amount" class="style-scope yt-live-chat-paid-message-renderer"> <yt-formatted-string
                class="style-scope yt-live-chat-paid-message-renderer">$&nbsp;100</yt-formatted-string> </div>
          </div>
        </div>
...
function T7Content() {
  const randomItem = Tier7C[Math.floor(Math.random() * Tier7C.length)];
...
export function TIER7_SUPERCHAT() {
  const functions = [T7Content];
