...
<div id="content" class="style-scope yt-live-chat-text-message-renderer"><span id="timestamp"
    class="style-scope yt-live-chat-text-message-renderer">2:23 PM</span> <yt-live-chat-author-chip
    class="style-scope yt-live-chat-text-message-renderer"> <span id="prepend-chat-badges"
      ...
      class="member style-scope yt-live-chat-author-chip">Member name<span id="chip-badges"
      ...
      class="style-scope yt-live-chat-author-chip"> <yt-live-chat-author-badge-renderer
        class="style-scope yt-live-chat-author-chip" aria-label="Pelanggan (6 bulan)" type="member"
        ...
        <div id="image" class="style-scope yt-live-chat-author-badge-renderer"><img
            ...
            class="style-scope yt-live-chat-author-badge-renderer" alt="Pelanggan (6 bulan)"></div>
      </yt-live-chat-author-badge-renderer> </span> </yt-live-chat-author-chip>​<span id="message" dir="auto"
    class="style-scope yt-live-chat-text-message-renderer">This is a member message <img
      ...
      shared-tooltip-text=":hand-pink-waving:" id="emoji-3"> </span> <span id="deleted-state"
...
export const MEMBER_CHAT = () => {
  const randomItem =
    MemberChats[Math.floor(Math.random() * MemberChats.length)];
  ...
  newItem.setAttribute('author-type', 'member');
